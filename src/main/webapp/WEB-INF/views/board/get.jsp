...
<div class="row">
   <div class="col-lg-12">
      ...
      <div class="panel-heading">
      	<i class="fa fa-comments fa-fw"></i>Reply
      	<button id="addReplyBtn" class="btn btn-primary btn-xs pull-reight">New Reply</button>
      	</div>
            ...
            <li class="left clearfix" data-rno='12'>
               <div>
                  <div class="header">
                     ...
                     <small   class="pull-right text-muted">2020-10-05 17:00</small>
                  </div>
                  <p>Good job!</p>
               </div>
            </li>
                   ...
                   <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                             <h4 class="modal-title" id="myModalLabel">REPLY MODEL</h4>
                                 </div>
      	    	                   <div class="modal-body">
        	   						<div class="form-group">
        	   							<label>Reply</label>
        	   							<input class="form-control" name='reply' value='New Rewply!!!'>
        	   						</div>
        	   						<div class="form-group">
        	   							<label>Replyer</label>
...
/* replyService.update({
	rno : 4,
	bno : bnoValue,
	reply : "Modified Reply...."},function(result){
		alert("수정 완료....")
	}); */
